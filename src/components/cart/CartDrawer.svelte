...
{#if $isCartDrawerOpen}
  ...
  <div class="fixed inset-0 overflow-hidden fixed-control">
    <div class="absolute inset-0 overflow-hidden fixed-control">
      <div
        class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-6 focus:outline-none fixed-control"
        tabindex="-1"
      ...
      >
        <div
          ...
          class="pointer-events-auto w-screen max-w-lg max-h-screen paper_pattern"
        >
          <div class="flex flex-col min-h-full max-h-screen">
            <div class="flex items-center justify-between p-2 border-b border-var(--color-paper-content)">
              <h2
    ...
    <div class="ml-3 flex h-7 items-center">
      <button
        ...
        class=""
      >
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="var(--color-paper-content"><path d="m251.33-204.67-46.66-46.66L433.33-480 204.67-708.67l46.66-46.66L480-526.67l228.67-228.66 46.66 46.66L526.67-480l228.66 228.67-46.66 46.66L480-433.33 251.33-204.67Z"/></svg>
      </button>
    </div>
  </div>
