...
<div class="relative flex items-center">
  <button
    ...
    class="relative z-60 transition-transform hover:scale-105 w-10 flex justify-center" 
    onclick={(e) => {
  ...
  {:else}
    <!-- Open your cart -->
    <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="30px" fill="04040f" class="">
